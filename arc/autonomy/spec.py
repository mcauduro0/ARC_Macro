...
# The one verified edge (Phase 4.2/4.3): 3-month time-series momentum on the 1Y DI receiver.
# Every field here is part of the binding contract; touching one is a new hypothesis.
